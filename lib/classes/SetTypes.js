...
var SetTypes = function SetTypes() {
  ...
  _defineProperty(this, "checkSchema", function (topValue, schema, specifiedFields, checkedValue, options) {
      ...
      if (specifiedFields.indexOf(key) !== -1) {
        ...
        if (Array.isArray(check.type)) {
          ...
          if (check.type.indexOf("any") === -1) {
            var _this$ierrors$push, _this$ierrors$push3, _this$ierrors$push4, _this$ierrors$push5;
            ...
            if (check.type.indexOf("array") === -1 && check.type.indexOf("int") !== -1 && check.type.indexOf("float") !== -1 && check.type.indexOf(_typeof(value)) === -1) _this.ierrors.push((_this$ierrors$push3 = {}, _defineProperty(_this$ierrors$push3, key, 'type_error'), _defineProperty(_this$ierrors$push3, "message", 'Data type check error.'), _this$ierrors$push3)); // ***************

            if (check.type.indexOf("array") === -1 && check.type.indexOf("int") !== -1 && !_this.checkIsInteger(value)) _this.ierrors.push((_this$ierrors$push4 = {}, _defineProperty(_this$ierrors$push4, key, 'type_error'), _defineProperty(_this$ierrors$push4, "message", 'Data type check error.'), _this$ierrors$push4));
            if (check.type.indexOf("array") === -1 && check.type.indexOf("float") !== -1 && !_this.checkIsFloat(value)) _this.ierrors.push((_this$ierrors$push5 = {}, _defineProperty(_this$ierrors$push5, key, 'type_error'), _defineProperty(_this$ierrors$push5, "message", 'Data type check error.'), _this$ierrors$push5)); // ***************
            ...
            if (check.of && isArray) {
              ...
              if (checkArrayOf.errors) _this.ierrors.push((_this$ierrors$push6 = {}, _defineProperty(_this$ierrors$push6, key, 'type_error'), _defineProperty(_this$ierrors$push6, "message", checkArrayOf.errors), _this$ierrors$push6));
            }
            ...
            if (check.match) {
              ...
              value.forEach(function (val) {
                ...
                if (!String(val).match(check.match)) _this.ierrors.push((_this$ierrors$push7 = {}, _defineProperty(_this$ierrors$push7, key, 'not_match'), _defineProperty(_this$ierrors$push7, "message", "Must match ".concat(check.match.toString(), " pattern.")), _this$ierrors$push7));
              });
            }
            ...
            if (check["enum"] && Array.isArray(check["enum"])) {
              if (isArray) {
                value.forEach(function (val) {
                  var _this$ierrors$push8;

                  if (check["enum"].indexOf(val) === -1) _this.ierrors.push((_this$ierrors$push8 = {}, _defineProperty(_this$ierrors$push8, key, 'not_enum'), _defineProperty(_this$ierrors$push8, "message", "Value must be one of [\"".concat(check["enum"].join('", "'), "\"].")), _this$ierrors$push8));
                });
              } else {
                var _this$ierrors$push9;

                if (check["enum"].indexOf(value) === -1) _this.ierrors.push((_this$ierrors$push9 = {}, _defineProperty(_this$ierrors$push9, key, 'not_enum'), _defineProperty(_this$ierrors$push9, "message", "Value must be one of [\"".concat(check["enum"].join('", "'), "\"].")), _this$ierrors$push9));
              }
          ...
          if (check.type !== "any") {
            ...
            if (check.type !== "array" && check.type !== "int" && check.type !== "float" && _typeof(value) !== check.type) _this.ierrors.push(_defineProperty({}, key, 'type_error')); // ***************

            if (check.type !== "array" && check.type == "int" && !_this.checkIsInteger(value)) _this.ierrors.push(_defineProperty({}, key, 'type_error'));
            if (check.type !== "array" && check.type == "float" && !_this.checkIsFloat(value)) _this.ierrors.push(_defineProperty({}, key, 'type_error')); // ***************

            if (check.of) {
              var _this$ierrors$push17;
              ...
              if (_checkArrayOf.errors) _this.ierrors.push((_this$ierrors$push17 = {}, _defineProperty(_this$ierrors$push17, key, 'type_error'), _defineProperty(_this$ierrors$push17, "message", _checkArrayOf.errors), _this$ierrors$push17));
            }

            if (check["enum"] && Array.isArray(check["enum"])) {
              if (isArray) {
                value.forEach(function (val) {
                  var _this$ierrors$push18;

                  if (check["enum"].indexOf(val) === -1) _this.ierrors.push((_this$ierrors$push18 = {}, _defineProperty(_this$ierrors$push18, key, 'not_enum'), _defineProperty(_this$ierrors$push18, "message", "Value must be one of [\"".concat(check["enum"].join('", "'), "\"].")), _this$ierrors$push18));
                });
              } else {
                var _this$ierrors$push19;

                if (check["enum"].indexOf(value) === -1) _this.ierrors.push((_this$ierrors$push19 = {}, _defineProperty(_this$ierrors$push19, key, 'not_enum'), _defineProperty(_this$ierrors$push19, "message", "Value must be one of [\"".concat(check["enum"].join('", "'), "\"].")), _this$ierrors$push19));
              }
            } else if (check["enum"] && !Array.isArray(check["enum"])) {
              throw new Error("TypeError: enum must be an array of values.");
            }

            if (check.match && !String(value).match(check.match)) _this.ierrors.push((_this$ierrors$push20 = {}, _defineProperty(_this$ierrors$push20, key, 'not_match'), _defineProperty(_this$ierrors$push20, "message", "Must match ".concat(check.match.toString(), " pattern.")), _this$ierrors$push20));
            if (check["default"] && (value == "" || value == null || value == undefined)) checkedValue[key] = check["default"];else checkedValue[key] = value;
          } else {
            checkedValue[key] = value;
          }
    ...
    Object.keys(schema.schema).forEach(function (key) {
      var _this$ierrors$push21;

      var check = schema.schema[key];
      var insertedValue = checkedValue[key];
      if (!insertedValue && check.required && !check["default"]) _this.ierrors.push((_this$ierrors$push21 = {}, _defineProperty(_this$ierrors$push21, key, 'required'), _defineProperty(_this$ierrors$push21, "message", 'Field is required.'), _this$ierrors$push21));
